...
public class SimpleCodeGeneratorConfigurationTest {
    ...
    public void extendInBuilderShouldNotAcceptNullElementTypeOrExtension() {
        expect(() -> builder.extend(null, mock(CodeGeneratorDelegate.class))).toThrow(AssertionError.class);
    ...
    public void getExtensionShouldReturnConfiguredExtension() {
        ...
        final CodeGeneratorDelegate extension = configuration.getExtension(context, codePointer);
    ...
    public void twoExtensionsCanBeConfiguredForTheSameElementWithDifferentSelectors() {
        ...
        configuration.getExtension(context, codePointerWithConstant1).apply(context, codePointerWithConstant1, out);
        ...
        configuration.getExtension(context, codePointerWithConstant2).apply(context, codePointerWithConstant2, out);
    ...
    public void threeExtensionsCanBeConfiguredOnTehSameElementWithDifferentSelectors() {
        ...
        configuration.getExtension(context, codePointer1).apply(context, codePointer1, out);
        configuration.getExtension(context, codePointer2).apply(context, codePointer2, out);
        configuration.getExtension(context, codePointer3).apply(context, codePointer3, out);
